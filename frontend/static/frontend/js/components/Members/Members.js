        ...
        query: gql`
          {
            ...
            inteComm: committeeMembers(committee: "I") {
              ...membersPageDetails
            }
            promosComm: committeeMembers(committee: "P") {
              ...membersPageDetails
            }
            logComm: committeeMembers(committee: "L") {
              ...membersPageDetails
            }
            finComm: committeeMembers(committee: "F") {
              ...membersPageDetails
            }
          }
      ...
      return (
        <div>
          ...
          <Container fluid className="my-5">
            <Type tag="h2" className="text-uppercase text-center mb-5">
              Executive Committee
            </Type>
            <Row className="row-cols-1 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 ">
              {ecOrder.map(ec => (
                <Col key={this.state.data[ec].id} className="mb-4 d-flex align-items-stretch">
                  <Card style={styles.killShadow} className="w-100">
                    ...
                    <CardBody>
                      <Type tag="h3" variant="h4-responsive">
                        {this.state.data[ec].firstName} {this.state.data[ec].lastName}
                      </Type>
                  ...
                  {this.state.data[comm].map((mem, i) => (
                    <Col key={this.state.data[comm][i].id} className="mb-4 d-flex align-items-stretch">
                      <Card style={styles.killShadow} className="w-100">
                        ...
                        <CardBody>
                          <Type tag="h3" variant="h4-responsive">
                            {this.state.data[comm][i].firstName} {this.state.data[comm][i].lastName}
                          </Type>
                          <p className="card-text">
